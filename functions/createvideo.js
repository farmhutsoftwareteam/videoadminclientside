...
export const uploadVideoAndAddToDB = async (videoFile, thumbnailFile, episodeDetails) => {
  try {
  

    const apiUrl = `${process.env.NEXT_PUBLIC_API_URL_SERVER}/api/upload-episode`; // Use the environment variable    
